...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-09-2022 a las 03:11:05
...
CREATE TABLE `persona` (
  ...
  `nombrefiscal` varchar(80) COLLATE utf8_spanish_ci NOT NULL,
  `direccionfiscal` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `toke` varchar(80) COLLATE utf8_spanish_ci NOT NULL,
  `rolid` bigint(20) NOT NULL,
  `datecreated` datetime NOT NULL DEFAULT current_timestamp(),
  `status` int(11) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `usuario` (`id`, `nombres`, `edad`) VALUES
(1, 'roberto', 20);
...
--
ALTER TABLE `rol`
  MODIFY `idrol` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
